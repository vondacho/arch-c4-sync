...
import edu.obya.c4.appl.config.TemplateConfigurationFactory
import edu.obya.c4.domain.C4Model
import edu.obya.c4.domain.C4Writer
import edu.obya.c4.domain.structurizr.util.allMicroservices
import edu.obya.c4.domain.structurizr.util.allSystems
