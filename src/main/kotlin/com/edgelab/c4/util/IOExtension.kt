...
fun String.toResourceStream(logger: Logger = "com.edgelab.c4.util.toResourceStream".logger()): InputStream? =
...
fun Path.toFileStream(logger: Logger = "com.edgelab.c4.util.toFileStream".logger()): InputStream? =
